    ...
    <div class="container">
        ...
        <div class="login-content">
            <form action="/new-acc">
                ...
                <h2 class="title">បង្កើតគណនីថ្មី</h2>
                ...
                <div class="input-div pass">
                    ...
                    <div class="div">
                        <input type="password" class="input" name="" id="" placeholder="បញ្ជាក់ពាក្យសម្ងាត់">
                    </div>
                </div>
                <div class="btn">
                    <button type="button"><a routerLink="">ចូលប្រើប្រាស់ថ្មី</a></button>
                </div>
